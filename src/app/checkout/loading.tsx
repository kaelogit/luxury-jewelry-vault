    ...
    <div className="fixed inset-0 bg-white flex flex-col items-center justify-center z-[100]">
      ...
      <div className="relative z-10 flex flex-col items-center gap-12">
        ...
        <div className="space-y-4 text-center">
          ...
          >
            <ShieldCheck size={14} />
            <span className="text-[9px] font-bold uppercase tracking-[0.4em]">Processing Secure Payment</span>
          </motion.div>
          ...
          <h3 className="text-3xl font-bold text-black tracking-tight overflow-hidden uppercase">
            <motion.span
              ...
              className="block"
            >
              Securing <span className="text-gold italic font-serif lowercase">your</span> Order
            </motion.span>
          </h3>
          
          <p className="text-[10px] text-gray-400 font-medium uppercase tracking-widest px-8 max-w-xs mx-auto leading-relaxed">
            Please do not refresh. Communicating with your bank.
          </p>
        </div>
      </div>
